...
<body>
    ...
    <aside class="ps-drawer--mobile">
        ...
        <div class="ps-drawer__content">
            <ul class="menu">
                <li><a class="active" href="{{ route('admin.dashboard.Admin') }}"><i
                ...
                <div class="ps-sidebar__top">
                    <div class="ps-block--user-wellcome">
                        ...
                        <div class="ps-block__right">
                            <p>Hello,<a href="{{ route('admin.dashboard.Admin') }}">{{ $user->name }}</a></p>
                        </div>
                ...
                <div class="ps-sidebar__content">
                    <div class="ps-sidebar__center">
                        <ul class="menu">
                            <li><a class="active" href="{{ route('admin.dashboard.Admin') }}"><i
                                        class="icon-home"></i>Dashboard</a></li>
                            <li><a href="{{ route('admin.update-matches') }}"><i class="icon-database"></i>Matches</a>
                            </li>

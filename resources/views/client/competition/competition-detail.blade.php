                            ...
                            @foreach ($competitions as $competition)
                                <div class="thumb">
                                    <a href="{{ route('competition.detail', ['id' => $competition->id]) }}" >
                                        <img src="{{ $competition->emblem }}" alt="movie">
                                    </a>
                                </div>
                            @endforeach
                        </div>
                                        ...
                                        <div class="casting-slider owl-carousel">
                                            ...
                                            <div class="cast-item">
                                                ...
                                                <div class="cast-content">
                                                    <h6 class="cast-title"><a href="{{ url('#') }}">{{$club->name}}</a></h6>
                                    ...
                                    <div class="item">
                                        ...
                                        <div class="casting-slider-two owl-carousel">
                                            ...
                                            <div class="cast-item">
                                                ...
                                                <div class="cast-content">
                                                    <h6 class="cast-title"><a href="{{ route('competition.detail', ['id' => $competition->id]) }}">{{$competition->name_of_competition}}</a></h6>
